...
def exportation_synonymes(mot):
    ...
    try:
        ...
        # Ajouter un assert pour vérifier que la longueur de synonymes trouvées est = au nombre affiché dans la page
        ...
        #Ce code ne fonctionne pas car la table ne présente que les premiers synonymes
    ...
    except requests.exceptions.ConnectTimeout: #si le site est down
        return False
